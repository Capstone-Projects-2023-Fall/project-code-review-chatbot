<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Before continuing, your email address will need to be verified. An email will be sent after manual approval from an admin. Please allow some time as an admin must manually approve users.') }}
        </div>
